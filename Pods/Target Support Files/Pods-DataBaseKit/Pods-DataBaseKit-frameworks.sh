...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-DataBaseKit/DateTools.framework"
  ...
  install_framework "Pods-DataBaseKit/ParseFacebookUtilsV4.framework"
  install_framework "Pods-DataBaseKit/ParseTwitterUtils.framework"
  install_framework "Pods-DataBaseKit/ParseUI.framework"
fi

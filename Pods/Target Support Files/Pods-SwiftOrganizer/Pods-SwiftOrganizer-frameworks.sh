...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-SwiftOrganizer/DateTools.framework"
  ...
  install_framework "Pods-SwiftOrganizer/ParseFacebookUtilsV4.framework"
  install_framework "Pods-SwiftOrganizer/ParseTwitterUtils.framework"
  install_framework "Pods-SwiftOrganizer/ParseUI.framework"
fi
